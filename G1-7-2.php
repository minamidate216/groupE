...
if($sql->rowCount() > 0){
    ...
    echo '<tr><th>注文番号：',$_POST['orderId'],'</th><th></th><th>購入日：',$_POST['Date'],'</th><th></th><th></th><th></th></tr>';
foreach($sql as $row){
...
echo '<tr><th></th><th></th><th></th><th></th><th>お買い上げ金額：',$total,'円</th></tr>';
echo '</table>';
}
else{
    echo $_POST['orderId'];

...
<a href="G1-1-1.php"><img src="image/ranch.png" height="130px" width="130px"><span class="has-text-white is-size-5">miyosi farm</a>
    ...
    <div class="column is-narrow">
        ...
        <div class="column is-narrow">
            <a href="G.php"><span class="has-text-white is-size-4"><i class="far fa-envelope"></i></span></a>
        </div>
        <div class="column is-narrow">
            <a href="G.php"><span class="has-text-white is-size-4"><i class="fas fa-user"></i></span></a>
        </div>
        <?php

...
if(isset($_SESSION['Users'])){
    ...
    if($judge!=1){
        ...
        echo '<div class="text_UN is-size-5">ユーザーネーム&ensp;&ensp;&emsp;&emsp;<input type="text" name="user_name"><br/></div>';
        echo '<div class="text_PA is-size-5">パスワード&emsp;&emsp;&emsp;&emsp;&emsp;<div style="display: inline"><input type="password" name="password"><br/></div></div>';
...
<style>
    .text_UN{
        margin: 50px 350px 30px 440px;
    }
    .text_PA{
        margin: 30px 400px 50px 440px 
    }
</style>
